...
//Length of Longest common subsequence using memoization [bottom up]
//ABC - STR1
//ABSFC - STR2
// answer=3 [ABC]
public class LCSubseqMemo {

    int size1;
    int target1;
    int[][] res1;

    LCSubseqMemo(int arr_len, int target) {
        size1 = arr_len;
        target1 = target;
    ...
    public static void main(String[] args) {
        ...
        LCSubseqMemo longestCommonSubseqMemo = new LCSubseqMemo(strings1.size()+1,strings2.size()+1 );
